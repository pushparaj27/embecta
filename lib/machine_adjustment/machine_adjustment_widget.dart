...
class _MachineAdjustmentWidgetState
    extends State<MachineAdjustmentWidget> with AutomaticKeepAliveClientMixin<MachineAdjustmentWidget>{

  List<String> _made = ['Replace/adjust FF&S jaws','Adjust FF&S jaw temperatures','Adjust webs/printer ensure 1/4" vertical seal overlap','Adjust registration marks of webs'];
  ...
  void updateData() async{
    for(int i=0;i<_result.length;i++){
      MachineAdjustmentModel machineAdjustmentModel = MachineAdjustmentModel('', false,_made[i],'' ,
...
*/
                  ...
                  return machineAdjustmentList(context, _machineAdjustmentList[dataIndex], dataIndex);
              },
            ),
  ...
  Widget machineAdjustmentList(BuildContext context, MachineAdjustmentModel machineAdjustmentModel, int index){
      ...
      children: [
        Align(alignment: Alignment.topCenter,child: Padding(
            ...
            child:Column(children: [
              ...
              Align(alignment: Alignment.topLeft,child: Text(machineAdjustmentModel.madeTitle,textAlign: TextAlign.start),),
              SizedBox(height: 10,),
              Column(
                children: [
                  Row(
                      ...
                      Expanded(child: Column(
                        ...
                        children: [
                          TextField(
                            ...
                            textInputAction: TextInputAction.next,
                            inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                            controller: TextEditingController()..text = machineAdjustmentModel.firstTime,
                            decoration: InputDecoration(
                              border: OutlineInputBorder(
                                  borderRadius: BorderRadius.all(
                                    Radius.circular(5),
                            ...
                            onTap: () {
                              machineAdjustmentModel.firstTime = CustomFunctions().currentTime();
                              setState(() {
                      ...
                      Expanded(child: Column(
                        ...
                        children: [
                          DropdownSearch<String>(
                            ...
                            onChanged: (val){
                              machineAdjustmentModel.firstResult = val.toString();
                              setState(() {
                      ...
                      Expanded(child: Column(
                        ...
                        children: [
                          TextField(
                            ...
                            textInputAction: TextInputAction.next,
                            inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                            controller: TextEditingController()..text = machineAdjustmentModel.secondTime,
                            decoration: InputDecoration(
                              border: OutlineInputBorder(
                                  borderRadius: BorderRadius.all(
                                    Radius.circular(5),
                            ...
                            onTap: () {
                              machineAdjustmentModel.secondTime = CustomFunctions().currentTime();
                              setState(() {
                      ...
                      Expanded(child: Column(
                        ...
                        children: [
                          DropdownSearch<String>(
                            enabled: machineAdjustmentModel.checkBox?false:true,
                            items: _result,
                            selectedItem: machineAdjustmentModel.secondResult,
                            popupProps: PopupProps.menu(
                              constraints: BoxConstraints(
                                  minHeight: 50,
                                  maxHeight: 200
                            ...
                            onChanged: (val){
                              machineAdjustmentModel.secondResult = val.toString();
                              setState(() {
                      ...
                      Expanded(child: Column(
                        ...
                        children: [
                          TextField(
                            ...
                            textInputAction: TextInputAction.next,
                            inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                            controller: TextEditingController()..text = machineAdjustmentModel.thirdTime,
                            decoration: InputDecoration(
                              border: OutlineInputBorder(
                                  borderRadius: BorderRadius.all(
                                    Radius.circular(5),
                            ...
                            onTap: () {
                              machineAdjustmentModel.thirdTime = CustomFunctions().currentTime();
                              setState(() {
                      ...
                      Expanded(child: Column(
                        ...
                        children: [
                          DropdownSearch<String>(
                            enabled: machineAdjustmentModel.checkBox?false:true,
                            items: _result,
                            selectedItem:  machineAdjustmentModel.thirdResult,
                            popupProps: PopupProps.menu(
                              constraints: BoxConstraints(
                                  minHeight: 50,
                                  maxHeight: 200
                            ...
                            onChanged: (val){
                              machineAdjustmentModel.thirdResult = val.toString();
                              setState(() {
